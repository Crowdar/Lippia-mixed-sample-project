...
public class UserSteps extends PageSteps {
    ...
    public void iPerformAGETToUsersEndpointWithTheIdId(String method, String entity, String jsonName, String jsonReplacementValues) throws IllegalAccessException, IllegalArgumentException, InvocationTargetException, NoSuchMethodException, SecurityException {
    	Map<String, String> parameters = null;
    	if(!jsonReplacementValues.isEmpty()) {
    		parameters = Splitter.on(",").withKeyValueSeparator(":").split(jsonReplacementValues);
    	}
    		
        EntityConfiguration.valueOf(entity).getEntityService().getMethod(method.toLowerCase(), String.class, Map.class).invoke("", jsonName, parameters);
    }
